function love.conf(t)
    t.identity = "PACMATH"                    -- The name of the save directory (string)
    ...
    t.window.title = "PAC-MATH|By DiegoG & RokkerMomo"        -- The window title (string)
    t.window.icon = "assets/graphics/icon.png"          -- Filepath to an image to use as the window's icon (string)
    ...
    t.window.msaa = -100                   -- The number of samples to use with multi-sampled antialiasing (number)
